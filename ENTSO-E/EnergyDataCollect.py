...
# Define the start date as the first day of the year
start_date = datetime(year, 1, 1)

# Iterate over each day from the start date until the current date
current = start_date
...
while current <= current_date:
    ...
    # Convert the current date to the desired format (YYYYMMDD)
    current_date_timestamp = current.strftime("%Y%m%d")

    # Make the API request for the current date using the timestamp
    # Perform any necessary operations with the API response
    # ...
